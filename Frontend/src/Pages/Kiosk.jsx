...
function Kiosk() {
  ...
  // Poll for scanned items from tablet
  useEffect(() => {
    ...
    <div className="min-h-screen bg-primary">
      ...
      <header className="bg-secondary border-b border-border px-6 py-4
        ...
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-accent-lighter rounded-lg flex items-center
                          justify-center">
        ...
        <div className="flex h-[calc(100vh-65px)]">
          ...
          <div className="flex-1 p-6 overflow-y-auto border-r border-border">
            <div className="max-w-lg mx-auto">
              ...
              <div className="bg-secondary border-2 border-dashed border-border
                              rounded-2xl p-8 text-center mb-6">
                <div className="w-16 h-16 bg-accent-lighter rounded-2xl
                                flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-accent" fill="none"
                       stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round"
                          strokeWidth={2} d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0
                ...
                <div className="mt-4 bg-surface rounded-xl px-4 py-2 inline-block">
                  <p className="text-text-secondary text-sm font-mono">
                    contactless-checkout.vercel.app/scanner
                  </p>
                </div>
              </div>

              {error && (
                <div className="bg-danger-light border border-danger
              ...
              <div className="bg-surface rounded-xl p-4 border border-border
                ...
                <p className="text-text-muted text-sm">
                  Tap your registered card on the reader to pay
                </p>
              </div>

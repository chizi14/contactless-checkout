    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-5 py-4 border-b border-border">
        <div className="flex items-center justify-between">
          <h2 className="text-text-primary font-semibold text-base">Cart</h2>
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4">
        {cart.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-text-secondary font-medium text-sm">Cart is empty</p>
            <p className="text-text-muted text-xs mt-1">Scan an item to get started</p>
          </div>
        ) : (
                ...
                <div className="w-9 h-9 bg-accent-lighter rounded-lg
                  ...
                  <svg className="w-4 h-4 text-accent" fill="none"
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round"
                          strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8
      ...
      <div className="px-5 py-4 border-t border-border space-y-3">
        ...
        <div className="w-full bg-accent text-white font-semibold py-3.5
